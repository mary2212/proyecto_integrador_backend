...
public interface VisitanteRepository extends JpaRepository<Visitante, Integer>{
	...
	@Query("select e from Visitante e where e.nombreVisitante = ?1 and e.idVisitante <> ?2")
	public List<Visitante> listaPorNombreDiferenteSiMismo(String nombreVisitante, int idVisitante);
}
